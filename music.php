...
<?php include("includes/sidebar.php"); ?>     
  ...
  <div id="mainContRight">
	<div id="profileheader">
        ...
        <div id="profileinfo">
  			<h2><?php echo $profile_fullname; ?>'s Music</h2>
        <!-- end#profileinfo --></div> 
  <!-- end #profileheader --></div>
	<div id="profilenav">
    	<div id="profilenavbox"><p><a href="photoalbum.php?profileid=<?php echo $profileid ?>&albumid=1">Album 1: Denny Cottage Stag Do</a></p>
    	</div>
        <div id="profilenavbox"><p><a href="photoalbum.php?profileid=<?php echo $profileid ?>&albumid=2">Album 2</a></p>
        </div>
        <div id="profilenavbox"><p><a href="photoalbum.php?profileid=<?php echo $profileid ?>&albumid=3">Album 3</a></p>
        </div>
        <div id="profilenavbox"><p><a href="photoalbum.php?profileid=<?php echo $profileid ?>&albumid=1">Album 4</a></p>
        </div>
    </div>  
 <br class="clearfloat" />
